...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-x-4 bottom-[calc(1rem+env(safe-area-inset-bottom))] z-50 mx-auto max-w-md rounded-2xl border border-ink-900/10 bg-surface p-4 shadow-lg">
