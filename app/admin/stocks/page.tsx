    ...
    <div>
      <div className="mb-6 flex items-center justify-between">
        ...
        <p className="text-xs text-ink-900/50">
          Pour réapprovisionner ou corriger un stock, ouvre le produit concerné dans "Produits".
        </p>
      </div>
      <Card className="p-0">
        <table className="w-full text-sm">
          ...
          <tbody>
            ...
            {rows.length === 0 && <tr><td colSpan={6} className="p-6 text-center text-ink-900/40">Aucune donnée de stock.</td></tr>}
          </tbody>
        </table>
      </Card>
    </div>
